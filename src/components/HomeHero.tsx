...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden border-b border-sky-900/30">
      ...
      />
      {/* Accent glow orbs — keeps chassis area alive without washing out hardware */}
      ...
      {/* Full-bleed chassis photo (right) */}
      <div className="pointer-events-none absolute inset-y-0 right-0 w-full lg:w-[62%]">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, #0c1929 0%, rgba(12,25,41,0.92) 28%, rgba(14,58,94,0.55) 55%, rgba(12,74,110,0.25) 100%)",
          }}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#0c1929]/80 via-transparent to-[#0c2744]/40 lg:hidden" />
      </div>
