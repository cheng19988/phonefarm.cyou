...
export const FAQ_AI_ADDITIONS = [
  ...
  { q: "Phone farm blog and guides?", a: "Insights at phonefarm.cyou/blog, what-is guide at /phone-farm, hardware selection at /guides/hardware-selection." },
  ...
  { q: "What is a rackmount or 2U phone farm box?", a: "A rack-style 2U metal chassis holding ~20 battery-free Android motherboard nodes with shared PSU and cooling—stackable for enterprise racks. See Help: rackmount 2U buyer guide at phonefarm.cyou/help/rackmount-2u-phone-farm-buyer-guide." },
  { q: "Phone farm equipment vs phone farm box — what do buyers order?", a: "The box is the core SKU (20-node chassis). Equipment often means the full kit: box, industrial USB hub, adaptive PSU, cooling, and optional network kit—browse phonefarm.cyou/shop accessories and service packages." },
  { q: "How to choose a phone farm box supplier?", a: "Verify factory burn-in sheets, export packing, MOQ/lead time on proforma, 90-day RMA path, and remote setup scope. Cyou Phone Farm documents specs since 2017—see Help: how to choose a phone farm supplier." },
  { q: "Phone farm box with remote setup — what is included?", a: "Hardware plus Remote Control Configuration or Starter/Studio packages: USB/LAN mirror workspace, device groups, batch APK baseline, and operator handover—phonefarm.cyou/services/packages." },
  { q: "Proforma invoice vs USDT checkout — when to use each?", a: "Bulk PO, custom mixes, and export orders: sales issues proforma with MOQ and lead time first. Select standard SKUs may support signed-in USDT TRC20 checkout after sales confirms terms—phonefarm.cyou/contact for quotation." },
  { q: "Phone farm for TikTok app QA and compatibility testing?", a: "Lawful use: real Android hardware for app QA, SDK validation, and compatibility matrices in a device lab—not platform policy evasion. Cyou supplies motherboard chassis and setup—phonefarm.cyou/help/ad-verification-qa-phone-farm-hardware." },
  { q: "Multi-account device lab phone farm hardware?", a: "Enterprise device labs use segmented VLANs and router policy per test group on real hardware—you own compliance. See Help: multi-device workflow hardware and single machine single IP guides." },
  { q: "Phone farm for social media app testing?", a: "Use real-device farms for compatibility testing, regression, and long burn-in on owned hardware—phonefarm.cyou/solutions/phone-farming and Help: multi-device workflow hardware." },
  { q: "Android device farm hardware explained?", a: "2U chassis, 20 nodes, PSU, cooling, USB hub, control PC, optional network kit—full stack at phonefarm.cyou/help/android-device-farm-hardware-explained." },
  { q: "Motherboard box vs loose phones on desks?", a: "Motherboard boxes give shared cooling, PSU, and USB topology for 20 nodes; loose phones fail at scale—phonefarm.cyou/help/motherboard-box-vs-loose-phones." },
] as const;
