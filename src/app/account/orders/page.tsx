...
export const metadata = buildMetadata({
  title: "My Orders",
  description: "Track phone farm hardware orders and USDT payment status.",
  path: "/account/orders",
});
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      <div className="mt-8 space-y-4">
        {orders.length === 0 && <p className="text-slate-400">No orders yet. <Link href="/shop" className="text-cyan-400">Shop now</Link></p>}
        {orders.map((o) => (
          <Link
            key={o.id}
